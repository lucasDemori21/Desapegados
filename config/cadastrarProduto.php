...
require("conexao.php");
    ...
    if(!isset($_POST['salvarBtn'])){
        ...
        $sql = "INSERT INTO produtos (id_produto, nome_produto, nome_img,  createDate,  status_produto,  descricao, id_categoria, qnt_produto) VALUES
        (null, '".$nomeProduto."', '".$array_nome_image."', '".date("Ymd")."', 1, '".$descricao."', '".$categoria."', 0);";
        if (mysqli_query($conn, $sql)) {
            echo "<script>
                ...
                }).then(()=>location.href='adduser.php');
                </script>";
        } else {
            echo "<script>
                    Swal.fire({
